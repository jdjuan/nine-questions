  ...
  return (
    <AnimatedLayout>
      <div className='border-t-8 border-yellow'>
        <div className='m-8 grid gap-10 sm:m-12 md:mx-auto md:max-w-2xl md:text-lg'>
          <div className='grid place-items-center gap-8 text-center text-green-200'>
            ...
            <div>
              <p className='mb-2 font-light text-green-400'>{perfectScore ? "Well done!" : "By the way:"}</p>
              <p className='rounded-md  border-2 border-yellow p-2 px-4 font-medium'>
                {perfectScore ? "As you noticed, a" : "A"}ll the inventions we showed you were made by women.
              </p>
            </div>
          </div>
          <div className='grid gap-4 font-light md:max-w-prose'>
            {!perfectScore && (
              <>
                <p>
                  If you picked men that looked like the stereotypical inventor,{" "}
                  <span className='text-green-200'>you shouldn&apos;t feel guilty.</span> The vast majority of
                  inventions are made by men.
                </p>
                <p>
            ...
            <p>
              ...
              <span className='text-green-200'>challenge our biases around gender roles</span> in society by
          ...
          <div className='mx-auto grid max-w-md rounded-xl border-2 p-5 pt-1 text-center text-sm md:px-6'>
            <p className='p-2 md:px-8'>
              ...
              <br />
              <br />
              <span className='text-green-200'>Share this project with them:</span>
            </p>
            <div className='mx-auto grid md:w-5/12'>
              <Button
                handleClick={() => {
